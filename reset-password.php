...
<head>
  ...
  <title>Reset Password | RP Attendance System</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
  <div class="container">
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarReset">
...
<div class="container-wrapper">
  <div class="reset-box">
    <div class="text-center">
      ...
      <p class="text-muted small mb-4">Please enter and confirm your new password below.</p>
    </div>
