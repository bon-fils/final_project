 ...
 * Clean, modern, and accessible student registration system
 * Features: Location management, real-time validation, progress tracking,
 *           photo upload, fingerprint capture, department-program cascading
 * Version: 2.2 - Modularized for improved maintainability
 * Dependencies: Bootstrap 5.3.0, Font Awesome 6.4.0, jQuery 3.7.0
 */
...
// Security: Initialize CSRF token for form protection
if (!isset($_SESSION['csrf_token'])) {
    $_SESSION['csrf_token'] = bin2hex(random_bytes(32));
}
$csrf_token = $_SESSION['csrf_token'];

// Data Layer: Fetch required data for form dropdowns
$departments = getDepartments($pdo);
$provinces = getProvinces($pdo);

// Validation: Ensure required data is available
validateRequiredData($departments);
?>
...
<head>
    ...
    <link rel="preload" href="js/register-student.js" as="script">
    <link rel="preload" href="css/register-student.css" as="style">
</head>
<body>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form id="registrationForm" enctype="multipart/form-data"
                            ...
                            <!-- Personal and Academic Information Section -->
                            <div class="row">
                                <!-- Personal Information Section -->
                                <?php include 'includes/form-personal-section.php'; ?>

                                <!-- Academic Information Section -->
                                <?php include 'includes/form-academic-section.php'; ?>
                            </div>

                            <!-- Parent/Guardian Information -->
                            <?php include 'includes/form-parent-section.php'; ?>

                            <!-- Location Information -->
                            <?php include 'includes/form-location-section.php'; ?>

                            <!-- Media Section -->
                            <?php include 'includes/form-media-section.php'; ?>

                            <!-- Submit Section -->
                            <?php include 'includes/form-submit-section.php'; ?>
                        </form>
                    </div>
                </div>

                <!-- Loading Overlay -->
                <div class="loading-overlay d-none" id="loadingOverlay" role="status" aria-live="polite">
                    <div class="spinner-border text-primary" role="status" aria-hidden="true">
                        <span class="visually-hidden">Loading...</span>
                    </div>
                    <div class="mt-2 fw-medium">Processing registration...</div>
                    <small class="text-muted mt-1">Please do not close this window</small>
                </div>
            ...
            try {
                ...
                document.getElementById('alertContainer').innerHTML = `
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <strong>System Error:</strong> Failed to initialize registration system. Please refresh the page.
