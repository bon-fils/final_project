...
<head>
    ...
    <style>
        /* Custom styles for admin-view-users.php - using admin-dashboard.css as base */
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li>
                <a href="admin-view-users.php" class="active">
            ...
            <li>
                <a href="#" onclick="showLeaveManagement()" class="leave-management-link">
    ...
    <script>
        // Leave Management Functions (same as admin-dashboard.php)
        ...
        function showLeaveManagement() {
            // Create leave management section if it doesn't exist
            if (!document.getElementById('leaveManagementSection')) {
                ...
                `;
                document.querySelector('.main-content').appendChild(leaveSection);
            }
        ...
        function hideLeaveManagement() {
            ...
            const leaveLink = document.querySelector('.leave-management-link');
            if (leaveLink) leaveLink.classList.remove('active');
        }
