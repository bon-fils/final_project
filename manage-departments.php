    ...
    <div class="card p-4">
      ...
      <table class="table table-hover table-bordered align-middle">
        ...
        <tbody>
          ...
          <!-- More departments will be dynamically loaded here -->
        </tbody>
      </table>
    </div>
  </div>
      ...
      <form class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="department_name" placeholder="e.g., Electrical Engineering" required>
          </div>

          <!-- HoD Selection -->
          <div class="mb-3">
            <label class="form-label">Head of Department (HoD)</label>
            <select class="form-select" name="hod_id" required>
              <option value="">-- Select HoD --</option>
              <option value="1">Jean Bosco Nshimiyimana</option>
              <option value="2">Grace Umutoni</option>
              <option value="3">Eric Mugisha</option>
